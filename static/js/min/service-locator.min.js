...
L.tileLayer("http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>',maxZoom:18,subdomains:[1,2,3,4]}).addTo(o),$("#service-locator-form").on("submit",function(t){t.preventDefault(),$(".status").remove()
...
var n=t
n.sort(i),$.each(n,function(t,i){new L.marker([i.latitude,i.longitude],{icon:e,title:i.name}).on("click",function(e){$(".service").removeClass("selected"),$("#"+i.id).addClass("selected"),$(".service-locator-results").scrollTop($(".service-locator-results").scrollTop()+$("#"+i.id).position().top)}).addTo(o)
